...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      metrics: ["94% Accuracy", "Real-time Processing", "Industrial Scale"],
    ...
    {
      title: "Mini Mercari",
      subtitle: "Marketplace with ML Price Intelligence",
      description: "A full-stack marketplace platform with a modern frontend, resilient backend API, and dedicated ML microservice for price suggestions. Built with deployment-grade structure including CI, Docker setup, service isolation, and public cloud hosting.",
      metrics: ["Full-Stack Delivery", "ML-Powered Pricing", "Cloud Deployed"],
      techStack: ["FastAPI", "Next.js", "SQLite", "Vercel", "Docker"],
      github: "https://github.com/qaim-b/mini-mercari",
      demo: "https://mini-mercari.vercel.app",
      highlight: false,
      image: "/images/mini-mercari.jpg",
      accentColor: "accent-amber",
    },
  ]
